...
main_menu.add(
    ...
    types.InlineKeyboardButton(text='⚡️ Мой профиль', callback_data='profile'),
    ...
    types.InlineKeyboardButton(text='☎️ Тех.поддержка', callback_data='tehpod'),
)
main_menu.add(
    types.InlineKeyboardButton(text='💸Продать токены', callback_data='sell_token'),
)
